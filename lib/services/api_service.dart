...
class ApiService {
  ...
  static Future<List<Recipe>> fetchRecipes(List<String> ingredients, {String? diet}) async {
    ...
    final String url =
        '$_baseUrl/recipes/complexSearch?ingredients=$ingredientsString&number=1&apiKey=$_apiKey$dietParam';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Gagal memuat resep(API sudah limit). Status code: ${response.statusCode}');
      }
    } catch (e) {
